...
TEST(BatchNormTest, ForwardTrainingTestWithSavedOutputsOpset9) {
  ...
  test.Run(OpTester::ExpectResult::kExpectSuccess, "", {kCudaExecutionProvider, kRocmExecutionProvider, kTensorrtExecutionProvider, kOpenVINOExecutionProvider, kDnnlExecutionProvider});
}
