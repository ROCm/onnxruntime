...
def verify_parity(
    ...
    ep = f"{args.execution_provider.upper()}ExecutionProvider" if args.execution_provider != "migraphx" else "MIGraphXExecutionProvider"
    if ep == "CUDAExecutionProvider" or ep == "MIGraphXExecutionProvider":
