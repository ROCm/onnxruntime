      ...
      external_empty_cache_{info.external_empty_cache}
{
  ...
  if (int8_enable_ ^ fp8_enable_) {
    int8_calibration_cache_name_ =
      int8_calibration_cache_name_env.empty() ?
        info.int8_calibration_table_name : int8_calibration_cache_name_env;
    int8_use_native_migraphx_calibration_table_ =
      int8_use_native_migraphx_calibration_table_env.empty() ?
        info.int8_use_native_calibration_table :
