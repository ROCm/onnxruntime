...
ProviderOptions MIGraphXExecutionProviderInfo::ToProviderOptions() const {
  return {
      {migraphx_provider_option::kDeviceId, MakeStringWithClassicLocale(device_id)},
      {migraphx_provider_option::kFp16Enable, MakeStringWithClassicLocale(fp16_enable)},
      {migraphx_provider_option::kBf16Enable, MakeStringWithClassicLocale(bf16_enable)},
      {migraphx_provider_option::kFp8Enable, MakeStringWithClassicLocale(fp8_enable)},
      {migraphx_provider_option::kInt8Enable, MakeStringWithClassicLocale(int8_enable)},
      {migraphx_provider_option::kModelCacheDir, MakeStringWithClassicLocale(model_cache_dir)},
      {migraphx_provider_option::kMemLimit, MakeStringWithClassicLocale(mem_limit)},
      {migraphx_provider_option::kArenaExtendStrategy, EnumToName(arena_extend_strategy_mapping, arena_extend_strategy)},
      {migraphx_provider_option::kExhaustiveTune, MakeStringWithClassicLocale(exhaustive_tune)},
      {migraphx_provider_option::kGpuExternalAlloc, MakeStringWithClassicLocale(external_alloc)},
      {migraphx_provider_option::kGpuExternalFree, MakeStringWithClassicLocale(external_free)},
      {migraphx_provider_option::kGpuExternalEmptyCache, MakeStringWithClassicLocale(external_empty_cache)},
  };
}
