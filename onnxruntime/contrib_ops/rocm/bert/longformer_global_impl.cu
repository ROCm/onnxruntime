...
void BuildGlobalIndex(
  ...
  hipLaunchKernelGGL(InitSequenceIndexKernel, batch_size, 128, 0, stream, sequence_index, sequence_length);
  ...
  hipcub::DevicePartition::Flagged(NULL, temp_storage_bytes, sequence_index,
  ...
  for (int i = 0; i < batch_size; ++i) {
    hipcub::DevicePartition::Flagged(reinterpret_cast<void*>(tmp_storage), temp_storage_bytes, sequence_index,
